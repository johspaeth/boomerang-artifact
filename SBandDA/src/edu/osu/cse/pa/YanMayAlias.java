...
public class YanMayAlias extends MayAliasAnalysis {
...
//				
	 ...
	 */	
	@Override
	public boolean mayAlias(Local var1, DefinitionStmt s1, SootMethod m1, Local var2, DefinitionStmt s2, SootMethod m2) {
...
//			}
	...
	public boolean manuBaseline(Local var1, SootMethod m1, Local var2, SootMethod m2) {		
		return ManuMayAliasAnalysis.v().mayAlias(var1,null, m1, var2,null, m2);
	}

	private static YanMayAlias ins;	

	public static YanMayAlias v() {
		if (ins == null) {
			ins = new YanMayAlias();
		}
		return ins;
