...
//		if (Util.MEASURE_PRECISION) resultCache.put(p, (res ? 1 : 0));
	...
	public static class DefaultMayAliasAnalysis extends MayAliasAnalysis {
		...
		public boolean mayAlias(Local v1,  DefinitionStmt s1,  SootMethod m1, Local v2, DefinitionStmt s2,  SootMethod m2) {
