...
public interface IInfoflowSolver {
   ...
   * @return True if the edge was scheduled, otherwise (e.g., if the edge has already been processed
   *         earlier) false
   */
   ...
   * @return The end summary of the given method for the given incoming abstraction
   */
  ...
  /**
   * Sets a handler that will be called when a followReturnsPastSeeds case happens, i.e., a taint
   * leaves a method for which we have not seen any callers
   * 
   * @param handler The handler to be called when a followReturnsPastSeeds case happens
   */
